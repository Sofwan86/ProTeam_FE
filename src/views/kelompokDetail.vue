      ...
      <v-row no-gutters>
        <v-col cols="12" sm="13" offset-sm="0.2">
          <v-card class="pa-2" offset-sm="3" outlined tile>
            <v-row>
              <v-col cols="12" md="6">
                <v-list-item two-line>
                  <v-list-item-content>
                    <v-list-item-title
                      ><h2>{{ kelompok.nama }}</h2></v-list-item-title
                    >
                    <v-list-item-subtitle
                      ><h4>141414141414</h4></v-list-item-subtitle
                    >
                    <v-list-item-subtitle
                      >Added 24 Januari 2021</v-list-item-subtitle
                    >
                  </v-list-item-content>
                </v-list-item>
              </v-col>
            ...
            <v-row>
              <v-col cols="12" md="6"><h2>Information</h2></v-col></v-row
            >
            <v-row>
              <v-col cols="4" md="3">
                <v-list-item two-line>
                  <v-list-item-content>
                    ...
                    <v-list-item-title v-for="skill in skills" :key="skill">{{
                      skill
                    }}</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              ...
              <v-col cols="4" md="3">
                <v-list-item two-line>
                  <v-list-item-content>
                    <v-list-item-subtitle>Total Pegawai</v-list-item-subtitle>
                    <v-list-item-title>{{ totalPeg }}</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
                <v-list-item two-line>
                  <v-list-item-content>
