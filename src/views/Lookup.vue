  ...
  <div>
    ...
    <v-container>
      <v-row no-gutters>
        ...
        <v-flex xs12 sm4>
          <p>Select Type</p>
          <v-select v-bind:items="items" overflow label="Select" item-value="item" item-text="name" v-model="selected"></v-select>
        </v-flex>
      </v-layout>
            </v-container>
            <v-row>
              <v-col>
                ...
                >
                  <template v-slot:top>
                    <v-toolbar flat>
                      <v-toolbar-title>Jenjang Jabatan</v-toolbar-title>
